...
public class PostController extends BaseController {
    ...
    public ResponsePostDTO getPostById(@PathVariable(value = "postId") int id) {
    ...
    public List<ResponsePostDTO> getAllPostsBySection(@PathVariable(value = "sectionId") int sectionId) {
        ...
        if (posts == null) {
            throw new NullPointerException("Posts with that section does not exist!");
        }
        return posts;
    }
    ...
    public List<ResponsePostDTO> getAllPostsByTag(@PathVariable(value = "tagId") int tagId) {
        ...
        if (posts == null) {
            throw new NullPointerException("Posts with that tag does not exist!");
        }
        return posts;
    }
