...
public class ResponsePostDTO extends Post  {
    ...
    public ResponsePostDTO(int postID, int profileID, String title, String contentURL, int sectionID, String creationDate, boolean seeSensitive, boolean atrributePoster, int commentsCounter, int votePoints) {
