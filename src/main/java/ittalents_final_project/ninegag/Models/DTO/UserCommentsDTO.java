...
@AllArgsConstructor
@NoArgsConstructor
public class UserCommentsDTO extends User {

    private List<ResponsePostDTO> commentedPosts;

    public UserCommentsDTO(int user_ID) {
        super(user_ID);
        this.commentedPosts = new ArrayList<>();
    }

    public UserCommentsDTO(int user_ID, String email, String username, String password, String salt, String full_name, Date date_created,
